...
employee_db: List[Employee] = [
    Employee(id=1001, name="Henry", Department="Powers", age=21),
    Employee(id=1011, name="Eleven", Department="Powers", age=12),
    Employee(id=1012, name="Will", Department="Powers", age=14),
    Employee(id=1022, name="Mike", Department="story-teller", age=14),
]
